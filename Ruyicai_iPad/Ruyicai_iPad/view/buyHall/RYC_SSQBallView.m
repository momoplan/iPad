...

{
    ...
    UIImageView*  bg_image = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, numListView.frame.size.width, 50*lineNum + 5)];
...
- (void)pressedBallButton:(id)sender
{
    ...
    messLabel.textAlignment = NSTextAlignmentCenter;//居中显示
