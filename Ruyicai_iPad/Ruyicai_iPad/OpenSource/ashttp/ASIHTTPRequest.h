...
typedef enum _ASINetworkReqestType
{
    ASINetworkRequestTypeBase = 1,
    ASINetworkRequestTypeUserLogin,
    ASINetworkRequestTypeUserReg,
    ASINetworkRequestTypeUpdatePsw,
    ASINetworkRequestTypeFeedback,
    ASINetworkRequestTypeSoftUpdate,
	ASINetworkRequestTypeSubmitLot,
	ASINetworkRequestTypeQueryLotBet,
	ASINetworkRequestTypeQueryLotWin,
	ASINetworkRequestTypeQueryTrack,
	ASINetworkRequestTypeQueryBalance,
    ASINetworkRequestTypeQueryGift,
    ASINetworkRequestTypeAccountDetail,
    ASINetworkRequestTypeQueryCash,
    ASINetworkRequestTypeGetCash,
    ASINetworkRequestTypeCancelCash,
    ASINetworkRequestTypeUpdatePass,
    ASINetworkRequestTypeGetLotteryInfo,
    ASINetworkRequestTypeQueryDNA,
    ASINetworkRequestTypeChargeDNA,
    ASINetworkRequestTypeChargePhoneCard,
    ASINetworkRequestTypeChargeUnionBankCard,
    ASINetworkRequestTypeChargeAlipay,
    ASINetworkReqestTypeChargeSecurityAlipay,
    ASINetworkReqestTypeChargeLaKaLa,
    ASINetworkRequestTypeQueryCaseLot,
    
    ASINetworkRequestTypeCancelAutoOrder,
    ASINetworkRequestTypeModifyAutoOrder,
    
    ASINetworkRequestTypeQueryCaseLot_AutoOrder,
    ASINetworkRequestTypeBetCaseLot,
    ASINetworkRequestTypeQueryAllCaseLot,
    ASINetworkRequestTypeQueryCaseLotDetail,
	ASINetworkRequestTypeLeftTime,
	ASINetworkRequestTypeCancelTrack,
	ASINetworkRequestTypeLaunchLot,
    ASINetworkRequestTypecreateAutoJoin,
    ASINetworkRequestTypeQueryLaunchStater,
	ASINetworkRequestTypeGetGiftInfo,
    ASINetworkRequestTypeGetTopWinner,
    ASINetworkReqestTypeBindCertid,
    ASINetworkReqestTypeBindPhoneSecurity,
    ASINetworkReqestTypeBindPhone,
    ASINetworkReqestTypeCancelBindPhone,
    ASINetworkRequestTypeFindPsw,
    ASINetworkRequestTypeGetInformation,
    ASINetworkRequestTypeGetInformationContent,
    ASINetworkRequestTypeHelpInformation,
    ASINetworkRequestTypeHelpContent,
    ASINetworkRequestTypeUserCenter,
    ASINetworkRequestTypeNickName,
    ASINetworkRequestTypeLeaveMessage,
    ASINetworkRequestTypeInLetterMessage,
    //    ASINetworkRequestTypeReceiveLotterySecurity,
    //    ASINetworkRequestTypeReceiveLottery,
    ASINetworkRequestTypeIntegralInfo,
    ASINetworkRequestTypeIntegralTransMoneyNeedsScores,
    ASINetworkRequestTypeTransIntegral,
    ASINetworkRequestTypeGetLotteryInfoList,
    ASINetworkReqestTypeGetActivityTitle,
    ASINetworkReqestTypeGetActivityContent,
    ASINetworkReqestTypeGetWinInfoDetail,
    ASINetworkReqestTypeGetExpertCode,
    ASINetworkReqestTypeGetJCLQDuiZhen,
    ASINetworkReqestTypeGetDataAnalysis,
    ASINetworkReqestTypeGetInstantScore,
    ASINetworkReqestTypeGetInstantScoreDetail,
    
    ASINetworkReqestTypeGetZCDuiZhen,
    
	ASINetworkRequestTypeGetJCLotteryInfo,
    ASINetworkRequestTypeQueryRecordCash,
    ASINetworkReqestTypeGetLotDate,
    //add by 黄鑫  开奖公告
    ASINetworkReqestTypeGetLotteryInfo,
    
    ASINetworkReqestTypeGetStartImage,
    ASINetworkReqestTypeMorePage,
    ASINetworkReqestTypeChargePage,
    ASINetworkReqestTypeGetTopNews,
    ASINetworkRequestTypeQueryTodayOpen,
    
    ASINetworkRequestTypeZCIssue,
    ASINetworkRequestTypeUnreadLetterCount,
} ASINetworkReqestType;

typedef enum _ASINetworkReqestTypeTwo
{
    ASINetworkRequestTypeBase_Two = 1,
    ASINetworkRequestTypeGetBetDetail_Two,
    ASINetworkRequestTypeGetBJDCmatch_Two,//北京单场对阵
//    ASINetworkRequestTypeQueryLiMeiState_Two,
}ASINetworkReqestTypeTwo;
...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	ASINetworkReqestType          requestType;
...
#pragma mark ===
@property (assign) ASINetworkReqestType requestType;
@property (assign) ASINetworkReqestTypeTwo requestTypeTwo;
